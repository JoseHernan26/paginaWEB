					...
					<form name="dgt" method="post" action="" onsubmit="return validar_form(this);">
							...
							<div class="row">
								<div class="col-md-3 text-center">
									...
									<button onclick="document.getElementById('captcha').src ='captcha/securimage_show.php?'+ Math.random();fococaptcha();return false" type="button" class="btn btn-sm btn-outline-success">	
										<i class="fas fa-sync" style="color:#008000"></i> </button>
								</div>
